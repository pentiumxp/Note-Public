...
| `ai_ops_evidence_ledger` | `$HOME/.homeai-qa/note-evidence-ledger.jsonl` |
...
| `plugin_manifest_actions_status` | `declared`; Note exposes manifest `actions` for host Dock `常用`, long-press menus, and search. |
